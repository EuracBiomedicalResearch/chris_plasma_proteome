...
cat("\n\\begin{figure}[H]\n")
cat("\\centering\n")
cat("  \\includegraphics[width=0.5\\textwidth]{",
    "images/manuscript/supplement/Figure_S150.png}\n", sep = "")
cat("  \\caption{Abundance of the protein Angiotensinogen (AGT) in study ",
    "participants using hormonal contraceptives ",
    "(HCU) and female and male participants that don't.}\n",
    sep = "")
cat("\\end{figure}\n")
...
The age association for the 3 most significant proteins is shown below.
...
## Sensitivity analysis: interactions between sex and BMI

```{r, results = "asis"}
cat("\n\\begin{figure}[H]\n")
cat("\\centering\n")
cat("  \\includegraphics[width=0.9\\textwidth]{",
    "images/manuscript/supplement/Figure_sensitivity_interaction.png}\n",
    sep = "")
cat("  \\caption{Comparison of effect sizes for models without (x-axis) and ",
    "with interaction between sex and BMI (y-axis) for coefficients Sex ",
    "(left), BMI category 3 against 2 (middle) and BMI category 4 against 2 ",
    "(right).}\n",
    sep = "")
cat("\\end{figure}\n")
