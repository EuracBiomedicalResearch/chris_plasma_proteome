---
title: "Supplementary Information for: \\textit{Mass spectrometry-based characterization of the plasma proteome in a large population cohort reveals strong influence from hormonal contraceptive use}"
output:
  pdf_document:
    includes:
...
pandoc.table(
    ...
    split.cells = 50, style = "rmarkdown", digits = 3,
    caption = paste0(
        "FDA qualified biomarker proteins quantified in the present data set. ",
