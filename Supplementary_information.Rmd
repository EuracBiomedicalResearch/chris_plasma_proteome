...
# Replication of results in the BASE II cohort

Influence of hormonal contraceptives on the plasma proteome of female study
participants below the age of 40 was validated using data from an independent
cohort, the BASE II study.

```{r, results = "asis"}
tmp <- data.frame(
    Female = c("240", "28.7 (3.1)", "", "", "22 (9.2%)",
               "172 (71.7%)", "31 (12.9%)", "15 (6.3%)"),
    Male = c("197", "29.2 (3.0)", "", "", "8 (4.1%)",
...
cat("\\centering\n")
cat("  \\includegraphics[width=0.7\\textwidth]{",
    "images/manuscript/supplement/pca_baseII_sex_hcu_yr.png}\n",
    sep = "")
cat("  \\caption{Principal component anaysis of the plasma proteome data",
    "from the BASE II cohort. BASE II plasma proteome data was restricted to",
...
# Influence of different combined oral contraceptives on the plasma proteome
...
cat("  \\caption{Abundances of proteins significantly associated with hormonal",
    "contraceptive use for different types of combined oral contraceptives.",
...
cat("  \\caption{Impact of previous use of hormonal contraceptives on the ",
    "plasma proteome. Left: results from the comparison between participants ",
