---
title: "Supplementary Information for: \\textit{Pervasive Influence of Hormonal Contraceptives on the Human Cirulating Proteome in a Broad Population Study}"
output:
  pdf_document:
    includes:
...
# Appendix A: Abundance Distribution of Individual Proteins

Distribution of $log_{2}$ transformed abundance distributions in the analyzed
...
for (i in seq_along(fls)) {
    ...
    cat("  \\includegraphics[width=0.9\\textwidth]{",
        fls[i], "}\n", sep = "")
    cat("  \\caption{Abundance distribution for of indicated proteins in ",
        "CHRIS study samples. Inter quartile range (IQR) in study samples and ",
        "coefficient of variation (CV) in study and quality control samples is",
