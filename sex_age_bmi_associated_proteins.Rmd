...
png("images/manuscript/_Figure_5B.png", width = 5,
...
#' PAPER, Figure 5C
#' ROC for AGT
png("images/manuscript/_Figure_5C.png", width = 5,
    height = 6, units = "cm", res = 600, pointsize = 4, type = "cairo-png")
par(mfrow = c(1, 1), mar = c(5, 6, 5, 1) + 0.1, cex.axis = 2, cex.lab = 2,
    bty = "n", cex.main = 2.5)
#' ROC
...
dir.create(dr, showWarnings = FALSE, recursive = TRUE)
png(paste0(dr, "_Figure_2AB.png"), width = 8.6, height = 4.1, units = "cm",
...
png(paste0("images/manuscript/_Figure_5A.png"), width = 5, height = 6,
    units = "cm", res = 600, pointsize = 4, type = "cairo-png")
par(mar=c(5,6,5,1)+.1, cex.lab = 2, cex.axis = 2, cex.main = 2.5, bty = "n")
...
```{r}
png(paste0("images/manuscript/_Figure_5F.png"), width = 5, height = 6,
    units = "cm", res = 600, pointsize = 4, type = "cairo-png")
...
mtext(side = 2, text = expression(ES["BASE-II"]), cex = 2, line = 3)
xat <- axTicks(1, usr = par("usr")[1:2])
labs <- gsub("-", "\U2212", print.default(xat))
axis(1, at = xat, labels = labs, padj = 0.4)
yat <- axTicks(2, usr = par("usr")[1:2])
...
png(paste0("images/manuscript/_Figure_5D.png"), width = 5, height = 6,
    units = "cm", res = 600, pointsize = 4, type = "cairo-png")
par(mar=c(5,6,5,1)+.1, cex.lab = 2, cex.axis = 2, cex.main = 2.5, bty = "n")
...
png("images/manuscript/_Figure_6A.png", width = 5, height = 5, units = "cm",
    res = 600, pointsize = 4, type = "cairo-png")
par(mfrow = c(1, 1), mar = c(3.5, 3.5, 1, 0.5), cex.lab = 1.5, bty = "n",
...
abline(l)
grid()
mtext(side = 1, text = expression(ES[EE]), cex = 2, line = 2.4)
mtext(side = 2, text = expression(ES[BE]), cex = 2, line = 2.1)
xat <- axTicks(1, usr = par("usr")[1:2])
labs <- gsub("-", "\U2212", print.default(xat))
axis(1, at = xat, labels = labs)
yat <- axTicks(2, usr = par("usr")[1:2])
...
png("images/manuscript/_Figure_6B.png", width = 5, height = 5, units = "cm",
    res = 600, pointsize = 4, type = "cairo-png")
par(mfrow = c(1, 1), mar = c(3.5, 3.5, 1, 0.5), cex.lab = 1.5, bty = "n",
    cex.axis = 1.5, cex = 1.5)
plot(a, d, pch = 21, col = "#00000080", bg = "#00000040",
...
grid()
mtext(side = 1, text = expression(ES[EE]), cex = 2, line = 2.4)
mtext(side = 2, text = expression(ES[P4]), cex = 2, line = 2.1)
xat <- axTicks(1, usr = par("usr")[1:2])
labs <- gsub("-", "\U2212", print.default(xat))
axis(1, at = xat, labels = labs)
yat <- axTicks(2, usr = par("usr")[1:2])
...
ggsave("images/manuscript/Figure_4.png", plot = plt, dpi = 600, width = 12,
