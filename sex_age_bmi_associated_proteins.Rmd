...
tab <- cbind(results_sens[sel, c("Genes", "coef_SexFemale", "p.adj_SexFemale")],
             results[sel, c("coef_SexFemale", "p.adj_SexFemale",
                            "coef_Sex_hormYes", "p.adj_Sex_hormYes")])
tab <- tab[order(tab[, 3]), ]
pandoc.table(
...
`r sum(results_sens$significant_SexFemale & results$significant_Sex_hormYes)`
...
`r sum(results_sens$significant_Age & results$significant_Sex_hormYes)` were
