...
plot_pca(pc_all, pch = NA, col = NA, xlim = c(-14, 10))
...
text(y[, 1] * 1.1, y[, 2] * 1.1, labels = prot_ann[rownames(y), "Genes"],
     col = rgb(0, 0, 0, alpha = a_lengths / max(a_lengths)), cex = 1.5)
...
plot(x = x, y = y, xlim = xl, ylim = xl,
     ...
     main = "", cex = 1.5)
mtext(text = expression(Sex~coef[adj]), side = 1, line = 3.6, cex = 1.3)
mtext(text = expression(Sex~coef), side = 2, line = 4, las = 0, cex = 1.3)
grid()
abline(0, 1)
...
plot(x = x, y = y, xlim = xl, ylim = xl,
     ...
     pch = 21, col = "#00000080", bg = bg,
     main = "", cex = 1.5)
mtext(text = expression(Age~coef[adj]), side = 1, line = 3.6, cex = 1.3)
mtext(text = expression(Age~coef), side = 2, line = 4, las = 0, cex = 1.3)
grid()
abline(0, 1)
...
plot(x = x, y = y, xlim = xl, ylim = xl,
     ...
     pch = 21, col = "#00000080", bg = bg,
     main = "", cex = 1.5)
mtext(text = expression(BMI~coef[adj]), side = 1, line = 3.6, cex = 1.3)
mtext(text = expression(BMI~coef), side = 2, line = 4, las = 0, cex = 1.3)
grid()
abline(0, 1)
...
sig_tab <- significant_table(
    results_hcu, columns = c("Uniprot", "Genes", "Description",
                             "coef_HCUYes", "p.adj_HCUYes",
                             "effect_size_HCUYes"), "HCUYes")
#' Exporting results
