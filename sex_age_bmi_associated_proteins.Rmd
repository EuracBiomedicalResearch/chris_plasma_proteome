...
The table above was exported and manually evaluated.
...
dir.create(dr, showWarnings = FALSE, recursive = TRUE)
png(paste0(dr, "_Figure_4ab.png"), width = 8.6, height = 4.1, units = "cm",
...
pheatmap(coefs, filename = paste0(dr, "_Figure_4c.png"),
...
```{r}
## Figure 4 paper.
png("images/manuscript/Figure_5.png", width = 12, height = 4, units = "cm",
    res = 600, pointsize = 4)
...
show an about 50% stronger effect than BE. The result from the linear model
comparing P4 against EE.
...
ethinylestradiol is stronger (on average about 50%). Progestogen containing
preparations, on the other hand, affect, if at all, different proteins and seem
to have in general a much lower impact on the plasma proteome.
...
```{r}
png("images/manuscript/Figure_3.png", width = 10, height = 5, units = "cm",
    res = 600, pointsize = 4, type = "cairo-png")
par(mfrow = c(1, 2), mar = c(4.5, 4.5, 1.5, 0.5), cex.lab = 1.5, bty = "n",
    cex.main = 2.5, cex.axis = 1.5, cex = 1.5)
