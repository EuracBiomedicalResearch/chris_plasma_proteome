...
png("images/manuscript/Figure_3.png", width = 12, height = 4, units = "cm",
    res = 600, pointsize = 4)
par(mfrow = c(1, 3), mar = c(4.5, 5.5, 1.5, 0.5), cex.lab = 2, bty = "n",
...
## Both together in one plot.
png("images/manuscript/Figure_6.png", width = 8, height = 4, units = "cm",
    res = 600, pointsize = 4, type = "cairo-png")
